...
// v0.13：走道之間的橫向棧板。原本全部是縱向貨架，方向性掩蔽是東西 45%／南北 19%，
// 差距 26 —— 縱向貨架決定了「東西向的交火才安全」，那不該是作者無意間決定的（§13.5）。
// 每段只有兩格，走道寬三格，所以還過得去。
function pallet(x, y) { set(m, x, y, '+'); set(m, x + 1, y, '+'); }
pallet(2, 6);   pallet(6, 9);   pallet(10, 5);
pallet(14, 12); pallet(18, 8);  pallet(22, 15);
pallet(2, 14);  pallet(6, 17);  pallet(10, 19);
pallet(14, 4);  pallet(18, 16); pallet(22, 6);
pallet(26, 11); pallet(26, 18);
...
const caches = [
  { pos: { x: 7, y: 11 }, label: '棧板上的補給', items: [{ defId: 'standard_5.56', qty: 10 }, { defId: 'buckshot_12ga', qty: 12 }] },
  { pos: { x: 19, y: 18 }, label: '翻倒的板條箱', items: [{ defId: 'SCRAP', qty: 2 }, { defId: 'standard_5.56', qty: 6 }, { defId: 'standard_9mm', qty: 20 }] },
  { pos: { x: 29, y: 5 }, label: '主管辦公室', items: [{ defId: 'CORE', qty: 1 }, { defId: 'OPTICS', qty: 1 }, { defId: 'standard_7.62', qty: 8 }] },
];
