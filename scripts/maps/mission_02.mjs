...
const caches = [
  { pos: { x: 18, y: 5 }, label: '管線工具箱', items: [{ defId: 'standard_5.56', qty: 10 }, { defId: 'buckshot_12ga', qty: 10 }] },
  { pos: { x: 6, y: 16 }, label: '維修備品櫃', items: [{ defId: 'OPTICS', qty: 1 }, { defId: 'SEALANT', qty: 1 }, { defId: 'standard_9mm', qty: 20 }] },
];
