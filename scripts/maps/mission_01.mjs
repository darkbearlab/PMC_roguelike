...
// v0.13：加入縱向掩體列。原本全部是水平排，方向性掩蔽是東西 24%／南北 51% ——
// 差距 27，等於作者無意間決定了「哪個軸向的交火是安全的」（§13.5）。
// 淨水場本來就有直立的管線與槽體，這幾道在敘事上不突兀。
V_(4, 1, 3, '+');       // A 起始室 縱管
V_(13, 1, 3, '+');      // B 北中室 縱管
V_(17, 2, 4, '+');      // B 東側
V_(25, 2, 5, '+');      // E 東北室
V_(27, 9, 12, '+');     // F 開闊地 縱向隔板
V_(4, 14, 16, '+');     // D 西南室
V_(12, 17, 19, '+');    // G 南中室 縱管
V_(18, 14, 16, '+');    // G 東側
V_(26, 16, 19, '+');    // H 終端室外
V_(6, 9, 11, '+');      // C 中央大廳 西側縱排
